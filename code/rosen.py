...
M = 5   # Use M walkers to calculate trial step
def Y(walkers, beta): 
...
# Configure Triangle plots using 'getdist' package
...
g.triangle_plot([corr_samples, MH_samples2, emcee_samples], filled=True, legend_labels=['ADS','MH Sph.','emcee'], legend_loc='upper right',legend_fontsize=16)
